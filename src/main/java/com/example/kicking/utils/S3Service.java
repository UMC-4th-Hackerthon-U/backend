package com.example.kicking.utils;
...
public class S3Service {
    ...
    public List<getS3ResultDto> uploadFile(List<MultipartFile> multipartFiles) {
        List<getS3ResultDto> fileList = new ArrayList<>();
        ...
        multipartFiles.forEach(file -> {
            ...
            fileList.add(new getS3ResultDto(s3Client.getUrl(bucket,fileName).toString()));
        });
        return fileList;
    }
